...
{ before(grammarAccess.getAtomAccess().getNamePREDICATE_NAMETerminalRuleCall_0_0()); }
	RULE_PREDICATE_NAME{ after(grammarAccess.getAtomAccess().getNamePREDICATE_NAMETerminalRuleCall_0_0()); }
)
...
{ before(grammarAccess.getTermAccess().getCsCONSTANT_SYMBOLTerminalRuleCall_0_0()); }
	RULE_CONSTANT_SYMBOL{ after(grammarAccess.getTermAccess().getCsCONSTANT_SYMBOLTerminalRuleCall_0_0()); }
)
...
{ before(grammarAccess.getTermAccess().getFsFUNCTIONAL_SYMBOLTerminalRuleCall_2_0_0()); }
	RULE_FUNCTIONAL_SYMBOL{ after(grammarAccess.getTermAccess().getFsFUNCTIONAL_SYMBOLTerminalRuleCall_2_0_0()); }
)
...
RULE_PREDICATE_NAME : 'a'..'z' ('a'..'z'|'A'..'Z'|'_'|'0'..'9')*;

RULE_CONSTANT_SYMBOL : 'a'..'z' ('a'..'z'|'A'..'Z'|'_'|'0'..'9')*;

RULE_FUNCTIONAL_SYMBOL : 'a'..'z' ('a'..'z'|'A'..'Z'|'_'|'0'..'9')*;
