 ...
 * <ul>
 *   <li>{@link net.certware.argument.language.l.impl.ArithmeticTermImpl#getMinus <em>Minus</em>}</li>
...
public class ArithmeticTermImpl extends BasicTermImpl implements ArithmeticTerm
{
  ...
  public void setMinus(String newMinus)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LPackage.ARITHMETIC_TERM__MINUS, oldMinus, minus));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LPackage.ARITHMETIC_TERM__MINUS:
        return getMinus();
      case LPackage.ARITHMETIC_TERM__TERM:
        return getTerm();
      case LPackage.ARITHMETIC_TERM__LHS:
